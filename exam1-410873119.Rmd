...
```{r ans1}
# sum300
levels(receipts300[1:300]) <- c(1,2,3,4,5,6,7,8,9)
num_receipts300<-factor(receipts300[1:300])
new_receipts300<-as.numeric(num_receipts300)
sum(new_receipts300[1:300])
```
...
```{r ans33}
# post
ymd_hms(tz="Asia/Taipei") -> a
c(post$comments$DateTime) -> b
paste0(a,b)
```
...
po
with_tz("4月25日下午3點50分",tzone="Europe/Poland")
